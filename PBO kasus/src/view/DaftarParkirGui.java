...
public class DaftarParkirGui extends Frame {
    ...
    protected void component() {
        adminLabel = new JLabel("Daftar Mobil Parkir");
    ...
    private DefaultTableModel createDataTable() {
        ...
        ArrayList<ParkirEntity> arrayParkir = parkirController.daftarMobilParkir();
        for (ParkirEntity parkir : arrayParkir) {
            Object[] data = new String[] {
                    parkir.getPlatNomor(),
                    parkir.getTanggalMasuk(),
            };
